...
В блоке «Резервный водитель» список показывает всех активных водителей. Доступные водители идут первыми и автоматически выстраиваются по очереди: сначала те, кто ещё не был резервным, затем — по наиболее давней дате последнего резерва. Водители с отсутствием остаются доступными для назначения и явно отмечаются своим статусом.
