...
- база ПТВ на странице «Работа»: наименование, категория, единица учёта и примечания; для каждого экземпляра — свой инвентарный номер, место хранения и состояние. Количество рассчитывается по числу экземпляров.
